...
const PHASES: Phase[] = [
  ...
  },
  {
    ...
    corrections: [],
    surprise:
      'Vercel couldn\'t find the Next.js directory in the monorepo -- needed to set Root Directory to website/ in the Dashboard. Deployment config is easier to overlook than code.',
    quote: '',
    tags: [
