...
import { ExperienceV3Page } from '@/components/experience-v3';
...
export function ExperienceV3PageClient() {
  ...
  // User is authenticated (READY state or later), show the V3 page
  return <ExperienceV3Page />;
}
