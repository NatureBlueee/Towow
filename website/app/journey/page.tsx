    ...
    <div className={styles.page}>
      ...
      <section className={styles.footer}>
        ...
        <ul className={styles.linkList}>
          <li>
            <a
              href="https://github.com/NatureBlueee/Towow/blob/main/docs/work_session_summaries.md"
              target="_blank"
          ...
          <li>
            <a
              href="https://github.com/NatureBlueee/Towow/blob/main/docs/ARCHITECTURE_DESIGN.md"
              target="_blank"
              rel="noopener noreferrer"
              className={styles.footerLink}
            >
