...
graph TD
    ...
    style T08 fill:#bfb,stroke:#333,stroke-width:2px
```
...
| **T08: E2E 测试** | T01, T05, T06 | - | 需要完整后端流程 |
...
```
T01 (2h) → T02 (3h) → T05 (4h) → T06 (3h) → T08 (4h)
         → T03 (3h) ↗
         → T04 (4h) ↗
