...
if [ -f "/Users/nature/个人项目/Towow/raphael/requirement_demo/towow-website/styles/team-matcher.css" ]; then
    # 检查关键动画定义
    if grep -q "@keyframes signal-pulse" "/Users/nature/个人项目/Towow/raphael/requirement_demo/towow-website/styles/team-matcher.css" && \
       grep -q "@keyframes fly-in" "/Users/nature/个人项目/Towow/raphael/requirement_demo/towow-website/styles/team-matcher.css" && \
       grep -q "prefers-reduced-motion" "/Users/nature/个人项目/Towow/raphael/requirement_demo/towow-website/styles/team-matcher.css"; then
...
cd /Users/nature/个人项目/Towow/raphael/requirement_demo/towow-website
...
if [ -f "/Users/nature/个人项目/Towow/raphael/requirement_demo/towow-website/lib/team-matcher/api.ts" ]; then
    # 检查是否包含所有必需的 mock 数据
    if grep -q "MOCK_TEAM_REQUEST" "/Users/nature/个人项目/Towow/raphael/requirement_demo/towow-website/lib/team-matcher/api.ts" && \
       grep -q "MOCK_PROPOSALS" "/Users/nature/个人项目/Towow/raphael/requirement_demo/towow-website/lib/team-matcher/api.ts" && \
       grep -q "MOCK_AGENTS" "/Users/nature/个人项目/Towow/raphael/requirement_demo/towow-website/lib/team-matcher/api.ts"; then
...
if grep -r "@media.*640px\|@media.*768px\|@media.*1024px" \
    /Users/nature/个人项目/Towow/raphael/requirement_demo/towow-website/styles/team-matcher.css \
    > /dev/null 2>&1; then
