...
- **代码**：Web 应用（建议 React/Vue + 可视化框架），提交到 `raphael/tools/hypervector-viz/`
- **文档**：README.md（使用说明、数据格式要求、部署方式）
- **降维方法对比报告**：Jupyter Notebook 或 Markdown，提交到 `raphael/research/H5_visualization/`
...
- 代码：`raphael/tools/hypervector-viz/`
- 降维研究：`raphael/research/H5_visualization/`

### 数据来源

- A1 完成后，从 `raphael/research/A1_HDC_encoding/` 获取编码函数和测试数据
