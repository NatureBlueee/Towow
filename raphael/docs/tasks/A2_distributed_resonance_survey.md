...
- `docs/ARCHITECTURE_DESIGN.md` Section 6.3 -- 签名共振机制（理解我们的共振检测是怎么工作的）
- `docs/ARCHITECTURE_DESIGN.md` Section 6.3.2 -- HDC 超维计算（理解我们用什么数据结构做相似度计算）
- `docs/ARCHITECTURE_DESIGN.md` Section 6.3.7 -- V1 简单广播 + 未来语义 Gossip 的初步设想
- `docs/ARCHITECTURE_DESIGN.md` Section 0 -- 设计原则（特别是 0.3 复杂度 O(N+M)、0.4 计算分布在端侧）
